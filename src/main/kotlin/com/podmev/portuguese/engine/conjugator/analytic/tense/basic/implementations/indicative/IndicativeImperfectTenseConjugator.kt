...
[21259] VerbFormInfo(infinitive=prostituir, tense=IndicativeImperfectTense, person=FIRST, number=SINGULAR, gender=UNDEFINED, voice=ACTIVE, settings=ConjugateSettings(ignoreDefective=false, portugueseLocale=BRAZIL))
[21261] VerbFormInfo(infinitive=prostituir, tense=IndicativeImperfectTense, person=SECOND, number=SINGULAR, gender=UNDEFINED, voice=ACTIVE, settings=ConjugateSettings(ignoreDefective=false, portugueseLocale=BRAZIL))
[21263] VerbFormInfo(infinitive=prostituir, tense=IndicativeImperfectTense, person=THIRD, number=SINGULAR, gender=UNDEFINED, voice=ACTIVE, settings=ConjugateSettings(ignoreDefective=false, portugueseLocale=BRAZIL))
[21264] VerbFormInfo(infinitive=prostituir, tense=IndicativeImperfectTense, person=THIRD, number=PLURAL, gender=UNDEFINED, voice=ACTIVE, settings=ConjugateSettings(ignoreDefective=false, portugueseLocale=BRAZIL))
